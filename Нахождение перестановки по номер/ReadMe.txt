========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта Нахождение перестановки по номер
========================================================================

Это приложение Нахождение перестановки по номер создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения Нахождение перестановки по номер.


Нахождение перестановки по номер.vcxproj
...
Нахождение перестановки по номер.vcxproj.filters
...
Нахождение перестановки по номер.cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем Нахождение перестановки по номер.pch и файла предкомпилированных типов с именем StdAfx.obj.
